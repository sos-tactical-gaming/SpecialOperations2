...
_zone = [position _fob, [SOS_MISSION_FOB_RADIUS * 0.1, SOS_MISSION_FOB_RADIUS * 0.1]] call SOS_fnc_createZone;
...
// create defense
_position = [position _fob, 10.0, SOS_MISSION_FOB_RADIUS * 0.1, 2.0, 2.0] call SOS_fnc_findSafePosition;
