...
_trigger setTriggerStatements[
    ...
    format ["if ((vehicle player isKindOf ""%1"") and (Player == driver vehicle player) and (isNil ""%2"")) then {[""driver vehicle player""] call SOS_fnc_activateServicePoint};",_vehicleType, _actionId],
