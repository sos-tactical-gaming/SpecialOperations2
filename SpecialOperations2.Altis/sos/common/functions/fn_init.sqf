...
if (!isDedicated) then {     
    ...
    [sos_spawn3, "TransportHelo",   position sos_spawn_position3, direction sos_spawn_position3, _radius, _delay, ["ReaperPilot", "ReaperReservedPilot"]] call SOS_fnc_addVehicleSpawn;

    [sos_spawn4, "Basic",           position sos_spawn_position4, direction sos_spawn_position4, _radius, _delay, []] call SOS_fnc_addVehicleSpawn;
    [sos_spawn4, "AttackHelo",      position sos_spawn_position4, direction sos_spawn_position4, _radius, _delay, ["ReaperPilot", "ReaperReservedPilot"]] call SOS_fnc_addVehicleSpawn;
    [sos_spawn4, "AdvancedHelo",    position sos_spawn_position4, direction sos_spawn_position4, _radius, _delay, ["ReaperPilot", "ReaperReservedPilot"], true] call SOS_fnc_addVehicleSpawn;
    ...
    // logistics spawn
    _delay = 300.0;
    [sos_spawn6, "AmmoCrate",       position sos_spawn_position6, direction sos_spawn_position6, _radius, _delay, ["PlatoonLeader", "GhostLeader", "GhostReconLeader", "ReaperPilot", "ReaperReservedPilot"]] call SOS_fnc_addLogisticsSpawn;
    [sos_spawn6, "MedicalCrate",    position sos_spawn_position6, direction sos_spawn_position6, _radius, _delay, ["PlatoonLeader", "GhostLeader", "GhostReconLeader", "ReaperPilot", "ReaperReservedPilot"]] call SOS_fnc_addLogisticsSpawn;
};
...
if (isServer) then {
    ...
    [getMarkerPos "sos_base", getMarkerSize "sos_base" select 0, true] spawn SOS_fnc_initMissionGenerator;    
};
