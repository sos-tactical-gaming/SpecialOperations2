...
if (!isDedicated) then {        
    ...
    // logistics spawn
    _delay = 300.0;
    [sos_spawn7, "AmmoCrate", position sos_spawn_position7, direction sos_spawn_position7, _radius, _delay, ["PlatoonLeader", "GhostLeader", "GhostReconLeader", "ReaperPilot"]] call SOS_fnc_addLogisticsSpawn;
    [sos_spawn7, "MedicalCrate", position sos_spawn_position7, direction sos_spawn_position7, _radius, _delay, ["PlatoonLeader", "GhostLeader", "GhostReconLeader", "ReaperPilot"]] call SOS_fnc_addLogisticsSpawn;
};
